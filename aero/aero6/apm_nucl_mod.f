...
!  (3 ) READJIMN   : CALCULATE IONIZATION RATE FOR ANY GIVEN LOCATION 
!
!  NOTES:
!  (1 ) .... 
!******************************************************************************
...
! reported in Yu (JGR, 2008) have been integrated. YUJIMN gives KBHN rates
...
!       YPATH = './'
        ...
        WRITE(6,*)"Read 5-D IMN look-up tables"
...
!
!------------------------------------------------------------------------------
      Subroutine IONRATE(ISURF, YPSURF, XLON, XLAT, XP, ZQ)
...
!******************************************************************************
!  Subroutine GEO2MAGLAT finds magnetic latitude from geo latitude and
!  longitude (Fangqun Yu, SUNY-Albany)
!
